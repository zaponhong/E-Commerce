<template>
    ...
    <div class="celine">
      <div>
        <img src="../../public/image/celine6.jpg">
        <a href="cart">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
            className="w-6 h-6" style="width:60px; height: 45px;">
            <path strokeLinecap="round" strokeLinejoin="round"
      ...
      <div>
        <img src="../../public/image/celine7.jpg">
        <a href="cart">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
            className="w-6 h-6" style="width:60px; height: 45px;">
            <path strokeLinecap="round" strokeLinejoin="round"
      ...
      <div>
        <img src="../../public/image/celine8.jpg">
        <a href="cart">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
            className="w-6 h-6" style="width:60px; height: 45px;">
            <path strokeLinecap="round" strokeLinejoin="round"
      ...
      <div>
        <img src="../../public/image/celine9.jpg">
        <a href="cart">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
            className="w-6 h-6" style="width:60px; height: 45px;">
            <path strokeLinecap="round" strokeLinejoin="round"
      ...
      <div>
        <img src="../../public/image/celine10.jpg">
        <a href="cart">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
            className="w-6 h-6" style="width:60px; height: 45px;">
            <path strokeLinecap="round" strokeLinejoin="round"
